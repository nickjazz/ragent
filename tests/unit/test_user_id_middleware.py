...
# --- T8.2a JWT path via Armasec (auth_disabled=false, trust_header=false) ---
...
def test_custom_jwt_header_and_claim_round_trip(armasec_token_manager, make_token) -> None:
    app = _build_app(
        jwt_header="X-Token",
        jwt_claim="sub",
        trust_header=False,
    ...
    # `sub` is a standard JWT claim; `build_rs256_token` sets it to "SAMPLE_SUB"
    # by default. Override to verify the claim path is honoured end-to-end.
