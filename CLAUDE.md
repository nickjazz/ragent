...
* Read `docs/00_domain_map.md` & `docs/00_api_call_chains.md` **before every task** — it defines the module domain boundaries, allowed dependency directions, and AI harness rules (R1–R7) that govern all code changes.
